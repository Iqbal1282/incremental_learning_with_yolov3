...
def Create_Yolov3(input_size=416, channels=3, training=False, CLASSES='',dot_name_file=False):
...
def compute_loss(pred, conv,  label, bboxes, i=0, CLASSES='', PRED_PREV ='', CLASSES_PREV = ''):
